module.exports = {
  siteMetadata: {
    ...
    description: `Per leggere questo blog non puoi fermarti al titolo, perché non c'è. In compenso ci sono degli articoli (anch'essi senza titolo) e qualche video.`,
